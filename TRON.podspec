Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/catsdeveloper/Cats.git'
  s.authors  = { 'Denys Telezhkin' => 'catsoperation@gmail.com' }
  s.source   = { :git => 'https://github.com/catsdeveloper/Cats.git', :tag => s.version.to_s }
  s.requires_arc = true
